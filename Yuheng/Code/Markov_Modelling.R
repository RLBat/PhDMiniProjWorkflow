...
## Import data
#Historic_assess <- read.csv("My_Workflow/Corrected_SpeciesHistory_deextinct_MBM_med.csv", header = T, stringsAsFactors = F)
...
Run_Markov <- function(Historic_assess, Q){
  ...
  Historic_assess$category <- as.integer(as.character(Historic_assess$category))
